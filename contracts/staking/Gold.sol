...
contract Gold is ERC20, Pausable, AccessControl {
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        require(
            _account != msg.sender,
            "FARM: must not add sender to blacklist"
        );
        require(
            _blackList[_account] == false,
            "FARM: account was on blacklist"
        );
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        require(
            _blackList[_account] == true,
            "FARM: account was not on blacklist"
        );
        _blackList[_account] = false;
    ...
    function _beforeTokenTransfer(
        ...
        require(
            ...
            "FARM: account sender was on blacklist"
        );
        require(
            _blackList[to] == false,
            "FARM: account recipient was on blacklist"
        );
